...
The Step 8 C# pipeline copies these files into a disposable workspace, adds the selected `.keymap` as `config/go60.keymap`, appends its generated layout identity,
and invokes the pinned Docker backend.
